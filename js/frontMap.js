...
_SPDEV.FrontMap.init = function(){
  ...
  tt_Bolivia.attr("style", "left:" + width/4.7 + "px;top:" + height/2.3 + "px").html("<div class='mmtitle'>BOLIVIA</div><div class='mmactivities'>6,568 ACTIVITIES</div><div class='mmimg'><img src='img/mmLogo.png'/></div>");
	tt_Kenya.attr("style", "left:" + width/2.05 + "px;top:" + height/3.1 + "px").html("<div class='mmtitle'>KENYA</div><div class='mmactivities'>2,243 ACTIVITIES</div><div class='mmimg'><img src='img/mmLogo.png'/></div>");
	tt_Nepal.attr("style", "left:" + width/1.6 + "px;top:" + height/5.3 + "px").html("<div class='mmtitle'>NEPAL</div><div class='mmactivities'>21,600ACTIVITIES</div><div class='mmimg'><img src='img/mmLogo.png'/></div>");
	tt_Malawi.attr("style", "left:" + width/2.05 + "px;top:" + height/1.33 + "px").html("<div class='mmtitle'>MALAWI</div><div class='mmactivities'>5,500 ACTIVITIES</div><div class='mmimg'><img src='img/mmLogo.png'/></div>");
